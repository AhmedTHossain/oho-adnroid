...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void startRegistration(){
        registrationViewModel.getRegistrationFormData().observe(this, profile -> {
            ...
            Log.d("RegisterActivity","phone final = "+profile.getPhone() + " gender final = "+profile.getSex() + " height final = "+profile.getHeight() + " dob final = "+profile.getDob() + " budget final = "+profile.getBudget() + " interested in = "+profile.getInterested_in() + " education = "+profile.getEducation() + " vaccinated = " + profile.getVaccinated());
        });
